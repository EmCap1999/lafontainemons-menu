...
import type { ItemInsert, SectionSelect, SubsectionSelect } from "@lafontaine/database/src/schema";
...
export async function seedItems(
	...
	for (const rawData of itemsRawData) {
		...
		const { sectionName: _sectionName, subsectionName: _subsectionName, ...itemFields } = rawData;
