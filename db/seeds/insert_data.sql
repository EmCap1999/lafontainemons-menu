...
VALUES
    ((SELECT section_id FROM public.section WHERE name = 'Les Vins'), 'Vin rosé, blanc & rouge', 1),
    ...
    ((SELECT section_id FROM public.section WHERE name = 'Bières'), 'Mons', 2);

INSERT INTO public.item (section_id, subsection_id, name, price, capacity, unit)
VALUES
    ((SELECT section_id FROM public.section WHERE name = 'Softs'), NULL, 'Chaudfontaine', 2.50, 25, 'cl'),
...
INSERT INTO public.item (section_id, subsection_id, name, price, capacity, unit)
VALUES
    ((SELECT section_id FROM public.section WHERE name = 'Desserts'), NULL, 'Moelleux chocolat/caramel et boule de glace', 8.00, NULL, NULL),
    ((SELECT section_id FROM public.section WHERE name = 'Desserts'), NULL, 'Tarte aux morceaux de pomme', 8.00, NULL, NULL),
    ((SELECT section_id FROM public.section WHERE name = 'Desserts'), NULL, 'Dame blanche au chocolat chaud', 8.00, NULL, NULL),
...
INSERT INTO public.item (section_id, subsection_id, name, price, capacity, unit)
VALUES
    ((SELECT section_id FROM public.section WHERE name = 'HotDrinks'), NULL, 'Café', 2.20, NULL, NULL),
    ...
    ((SELECT section_id FROM public.section WHERE name = 'HotDrinks'), NULL, 'Irish Coffee maison', 8.00, NULL, NULL),
...
VALUES
    ((SELECT section_id FROM public.section WHERE name = 'Les Vins'),
     (SELECT subsection_id FROM public.subsection WHERE name = 'Vin rosé, blanc & rouge' AND section_id = (SELECT section_id FROM public.section WHERE name = 'Les Vins')),
    ...
    ((SELECT section_id FROM public.section WHERE name = 'Les Vins'),
     ...
     'Pichet', 16.00, 50, 'cl'),
    ((SELECT section_id FROM public.section WHERE name = 'Les Vins'),
     (SELECT subsection_id FROM public.subsection WHERE name = 'Sélection du Patron' AND section_id = (SELECT section_id FROM public.section WHERE name = 'Les Vins')),
     'La bouteille', 25.00, 75, 'cl');

INSERT INTO public.item (section_id, subsection_id, name, price, capacity, unit)
VALUES
    ((SELECT section_id FROM public.section WHERE name = 'Bières'),
     (SELECT subsection_id FROM public.subsection WHERE name = 'Au fût' AND section_id = (SELECT section_id FROM public.section WHERE name = 'Bières')),
     'Jupiler', 2.30, 25, 'cl'),
    ((SELECT section_id FROM public.section WHERE name = 'Bières'),
     (SELECT subsection_id FROM public.subsection WHERE name = 'Au fût' AND section_id = (SELECT section_id FROM public.section WHERE name = 'Bières')),
     'Jupiler', 3.00, 33, 'cl'),
    ((SELECT section_id FROM public.section WHERE name = 'Bières'),
     (SELECT subsection_id FROM public.subsection WHERE name = 'Mons' AND section_id = (SELECT section_id FROM public.section WHERE name = 'Bières')),
     'Saint-Lazare 002 Saison', 4.50, 33, 'cl'),
    ((SELECT section_id FROM public.section WHERE name = 'Bières'),
     (SELECT subsection_id FROM public.subsection WHERE name = 'Mons' AND section_id = (SELECT section_id FROM public.section WHERE name = 'Bières')),
     'Saint-Lazare 006 IPA', 4.50, 33, 'cl'),
    ((SELECT section_id FROM public.section WHERE name = 'Bières'), NULL, 'Saint-Feuillien blonde', 4.50, 33, 'cl'),
    ...
    ((SELECT section_id FROM public.section WHERE name = 'Bières'), NULL, 'Saint-Feuillien Grand cru', 5.00, 33, 'cl'),
...
INSERT INTO public.item (section_id, subsection_id, name, price, capacity, unit)
VALUES
    ((SELECT section_id FROM public.section WHERE name = 'Apéritifs'), NULL, 'Apéritif maison', 9.00, NULL, NULL),
    ((SELECT section_id FROM public.section WHERE name = 'Apéritifs'), NULL, 'Spritz', 9.00, NULL, NULL),
    ((SELECT section_id FROM public.section WHERE name = 'Apéritifs'), NULL, 'Martini blanc ou rouge', 5.00, NULL, NULL),
    ((SELECT section_id FROM public.section WHERE name = 'Apéritifs'), NULL, 'Porto', 7.00, NULL, NULL),
    ((SELECT section_id FROM public.section WHERE name = 'Apéritifs'), NULL, 'Pineau des Charentes', 7.00, NULL, NULL),
    ...
    ((SELECT section_id FROM public.section WHERE name = 'Apéritifs'), NULL, 'Funny Pisang orange 0%', 5.00, NULL, NULL),
...
INSERT INTO public.item (section_id, subsection_id, name, price, capacity, unit)
VALUES
    ((SELECT section_id FROM public.section WHERE name = 'Alcools'), NULL, 'Cocktail maison', 7.00, NULL, NULL),
    ...
    ((SELECT section_id FROM public.section WHERE name = 'Alcools'), NULL, 'Rhum vanillé de Martinique', 8.00, NULL, NULL),
